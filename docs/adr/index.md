...
| [0041](./0041-a-queue-is-one-list-a-reader-narrows-and-a-reading-is-a-way-in.md) | A queue is one list a reader narrows, and a reading is a way in to its work *(reverses 0031 on one card per Owner and 0039 §2's guard; builds 0035's “a Finding code is a surface” into the row; keeps 0039 §2's disclosure and LAW-006's denominator under every filter)* |
